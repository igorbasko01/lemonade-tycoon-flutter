...
import 'package:lemonade_tycoon/screens/prepare_lemonade_screen.dart';
import 'package:lemonade_tycoon/view_models/game_view_model.dart';
import 'package:provider/provider.dart';

void main() {
  testWidgets('PrepareLemonadeScreen displays recipes and prepare button', (
    WidgetTester tester,
  ) async {
    ...
    expect(
      find.descendant(of: sweetCard, matching: find.text('In Stock: 1')),
      findsOneWidget,
    );
  });

  testWidgets('Prepare button disabled if ingredients missing', (
    WidgetTester tester,
  ) async {
    ...
    final prepareButton = tester.widget<ElevatedButton>(
      find.widgetWithText(ElevatedButton, 'Prepare').first,
    );
